            ...
            VStack(spacing: 6) {
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: isHovered ? 12 : 8)
                        .stroke(
                            isSelected ? IntentiveColors.purplePrimary :
                ...
                // Selected glow
                .shadow(
                    color: isSelected ? IntentiveColors.purplePrimary.opacity(0.5) : .clear,
                ...
                Text(screenshot.formattedTime)
                    ...
                    .foregroundColor(isSelected ? IntentiveColors.purplePrimary : .white.opacity(0.7))
