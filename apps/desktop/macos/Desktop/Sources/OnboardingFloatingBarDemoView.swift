    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 28) {
                VStack(spacing: 12) {
                    if !barActivated {
                        Text("Intentive sees your screen and gives you capture-aware responses")
                            .font(.system(size: 20, weight: .bold))
                            .foregroundColor(IntentiveColors.textPrimary)
                            .multilineTextAlignment(.center)
                            .frame(maxWidth: 560)

                        Text("Press this shortcut to open the Floating Bar.")
                ...
                if !barActivated {
                    VStack(spacing: 12) {
                        ...
                        Text("The Floating Bar opens at the top of your screen.")
                            .font(.system(size: 13))
                            .foregroundColor(IntentiveColors.textTertiary)
                    }
                    .padding(.top, 4)
        ...
        Text(key)
            ...
            .background(
                RoundedRectangle(cornerRadius: 8)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 8)
                            .stroke(IntentiveColors.backgroundQuaternary.opacity(0.5), lineWidth: 1)
                    )
