...
struct OnboardingVoiceDemoView: View {
        ...
        VStack(spacing: 0) {
            ...
            VStack(spacing: 24) {
                ...
                if outputReadiness.shouldAskUserToTurnUpVolume {
                    ...
                    Text(waitingForResponse ? "Waiting for Intentive to respond..." : "Listening... release when done")
                        .font(.system(size: 13))
                        .foregroundColor(IntentiveColors.textTertiary)
                        .padding(.top, 4)
                        .transition(.opacity)
    ...
    private var volumeWarning: some View {
        VStack(spacing: 12) {
            ...
            Text("Turn up your Mac volume so you can hear Intentive respond, then try push-to-talk.")
                .font(.system(size: 13))
                .foregroundColor(IntentiveColors.textTertiary)
                .multilineTextAlignment(.center)
