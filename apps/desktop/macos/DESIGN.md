...
- **All macOS apps** → Read [`references/layout-and-composition.md`](references/layout-and-composition.md) (required)
- **Apps with keyboard shortcuts, panels, toasts, popovers** → Read [`references/interaction-patterns.md`](references/interaction-patterns.md)
- **Light/dark mode, color, typography** → Read [`references/visual-design.md`](references/visual-design.md)
