...
-- client_kind and the APNs/FCM push token used by push fan-out (#49). The
...
--
-- Token lifecycle is create+refresh only (Apple/FCM-aligned): a re-register with
...
-- signal a later stale-TTL prune reads. FCM is stored but not delivered in v1.
--
