...
| FB-002     | `oversized-file:apps/desktop/src-tauri/src/domains/snapshots/runtime/heartbeat/tests.rs`, `oversized-file:apps/desktop/src-tauri/src/domains/capture/runtime/screenpipe_supervisor/tests.rs`      | dropped | desktop  | Superseded when the Tauri/Rust Desktop tree was removed for native SwiftPM     |      |
