...
| --- | ------------------ | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 38  | Agent Runtime      | [Context Snapshots + Session End Markers](https://github.com/sruj75/Intentive/issues/38)       | `#37` closed; required for #40                                                                                                                                                                         |
...
### Agent Runtime (issues #16, #24, #25, #28–#29, #36–#37 closed; #38–#42 open)
...
- **Next:** `#38` (Context Snapshots ingress) and `#41` (Post-Message-Back) on the closed turn + memory spine; `#39` (Cron) can run in parallel with `#41`.
