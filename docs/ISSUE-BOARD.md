...
| --- | ------------------ | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 39  | Agent Runtime      | [Cron](https://github.com/sruj75/Intentive/issues/39)                                          | `#29` closed; parallel with #40/#41                                                                                                                                                                    |
| 40  | Agent Runtime      | [Heartbeat](https://github.com/sruj75/Intentive/issues/40)                                     | `#38` closed; perception ingress + Sensory Buffer landed — ready for Heartbeat cadence                                                                                                                 |
...
| 42  | Agent Runtime      | [Observability / safety / prod readiness](https://github.com/sruj75/Intentive/issues/42)       | Blocked by #39/#40/#41                                                                                                                                                                                 |
...
| #42 Agent Runtime — Observability/prod readiness | #39, #40, #41                                | Explicit `Blocked by` chain in issue                   | Re-plan hardening sprint after trigger + push slices land |
...
### Agent Runtime (issues #16, #24, #25, #28–#29, #36–#38 closed; #39–#42 open)
...
- **Next:** `#40` (Heartbeat) and `#41` (Post-Message-Back) on the closed turn + perception spine; `#39` (Cron) can run in parallel with `#40`/`#41`.
