...
- Closed: `#7`–`#33` — Desktop v1 foundation (`#7`–`#13`), shared protocol/api-contract + Providers auth (`#14`–`#15`), AR/CP contract roots (`#16`–`#17`, [PR #57](https://github.com/sruj75/Intentive/pull/57)), Mobile foundation lane (`#18`–`#22`, [PR #57](https://github.com/sruj75/Intentive/pull/57), [PR #58](https://github.com/sruj75/Intentive/pull/58)), CP Identity + mobile launch hydration (`#23`, commit `8e65c71`), AR Runtime skeleton + WS gateway and CP Pre-Chat Gate (`#24`–`#26`, [PR #62](https://github.com/sruj75/Intentive/pull/62)), CP Device Registry + device-aware gates (`#27`, [PR #63](https://github.com/sruj75/Intentive/pull/63)), AR Sessions / Ordering / Event Ledger (`#28`, commit `ce43ad7`), AR Conversation History + reconnect snapshot (`#29`, [PR #65](https://github.com/sruj75/Intentive/pull/65)), CP Routing + Agent Instance + Session Start (`#30`, commit `a703b1e`), Desktop Routing + Protocol WS session (`#31`, [PR #71](https://github.com/sruj75/Intentive/pull/71)), Desktop Capture Permission Setup (`#32`, [PR #72](https://github.com/sruj75/Intentive/pull/72)), Mobile Protocol Runtime Adapter (`#33`, [PR #73](https://github.com/sruj75/Intentive/pull/73))
- Open: `#34`–`#56`

## Executive Next Move

**Latest closure:** [#33 Mobile Protocol client](https://github.com/sruj75/Intentive/issues/33) ([PR #73](https://github.com/sruj75/Intentive/pull/73)) — Protocol-backed **Runtime Adapter** with push-side `useExternalStoreRuntime`, in-memory **Message Store**, `GET /agent` routing client, outbound queue-until-`hello_ok`, reconnect-generation guards, and server-authored opening idempotency ([ADR-0015](https://github.com/sruj75/Intentive/blob/main/apps/mobile/docs/adr/0015-mobile-push-external-store-runtime-for-proactive-companion.md), [ADR-0016](https://github.com/sruj75/Intentive/blob/main/apps/mobile/docs/adr/0016-mobile-no-client-authored-opening-idempotent-by-store.md)). Prior desktop capture closure ([#32](https://github.com/sruj75/Intentive/issues/32), [PR #72](https://github.com/sruj75/Intentive/pull/72)) is recorded in Operating Frame and the Closed table.

**Now:** [#44 Mobile Reconnect hydration](https://github.com/sruj75/Intentive/issues/44) and [#34 Desktop Snapshot emit](https://github.com/sruj75/Intentive/issues/34) — parallel Protocol lanes on each client. Shared [#51](https://github.com/sruj75/Intentive/issues/51)/[#52](https://github.com/sruj75/Intentive/issues/52) are independently startable.
...
| 44  | Mobile     | [Reconnect hydration](https://github.com/sruj75/Intentive/issues/44)                  | `#33` + `#29` closed                      | #45      |

### Phase 2: Next

| #   | Deployable | Issue                                                                       | Blocker cleared by | Unblocks |
| --- | ---------- | --------------------------------------------------------------------------- | ------------------ | -------- |
| 35  | Desktop    | [Signed-in happy-path smoke](https://github.com/sruj75/Intentive/issues/35) | #34 (closed #32)   | #43/#55  |

### Phase 3: Later

| #   | Deployable         | Issue                                                                                          | Wait reason                               | Notes                                                                                                                                                                                                           |
| --- | ------------------ | ---------------------------------------------------------------------------------------------- | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 36  | Agent Runtime      | [DeepAgents integration](https://github.com/sruj75/Intentive/issues/36)                        | #29 closed                                | Snapshot path landed in #29; owns companion-message persistence via `conversation.append` (one call, verify by reconnect) — [scope-down](https://github.com/sruj75/Intentive/issues/36#issuecomment-4666590934) |
...
| 39  | Agent Runtime      | [Cron](https://github.com/sruj75/Intentive/issues/39)                                          | #29 closed                                | Parallel with #41 after #29                                                                                                                                                                                     |
| 40  | Agent Runtime      | [Heartbeat](https://github.com/sruj75/Intentive/issues/40)                                     | #38                                       | Periodic trigger lane                                                                                                                                                                                           |
| 41  | Agent Runtime      | [Post-Message-Back + push handoff](https://github.com/sruj75/Intentive/issues/41)              | #29 closed                                | CP push handoff dependency; owns live outbound delivery + per-user connected-client registry (deferred from #29) — [scope-down](https://github.com/sruj75/Intentive/issues/41#issuecomment-4666591065)          |
...
| 44  | Mobile             | [Reconnect hydration](https://github.com/sruj75/Intentive/issues/44)                           | #33 closed + #29 closed                   | Server-truth conversation behavior                                                                                                                                                                              |
...
| 55  | Desktop            | [Final packaged-app release smoke](https://github.com/sruj75/Intentive/issues/55)              | #43/#53/#54                               | Release bar                                                                                                                                                                                                     |
