...
| 39  | Agent Runtime | [Cron](https://github.com/sruj75/Intentive/issues/39)                                                          | closed (branch `issue-39`) — `/crons/` filesystem cards, poll-loop scheduler, ephemeral silent cron turns + `cron_runs`, `client_tz` persistence, migrations `0006`–`0008`, ADR-0024/0025/0026; unblocks #42                                                            |
...
| #42 Agent Runtime — Observability/prod readiness | #40, #41                                     | Explicit `Blocked by` chain in issue                   | Re-plan hardening sprint after trigger + push slices land |
...
### Agent Runtime (issues #16, #24, #25, #28–#29, #36–#39 closed; #40–#42 open)
...
- **Next:** `#40` (Heartbeat) and `#41` (Post-Message-Back) on the closed turn + perception + cron spine.
