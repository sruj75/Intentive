...
- Closed: `#7`–`#36` — Desktop v1 foundation (`#7`–`#13`), shared protocol/api-contract + Providers auth (`#14`–`#15`), AR/CP contract roots (`#16`–`#17`, [PR #57](https://github.com/sruj75/Intentive/pull/57)), Mobile foundation lane (`#18`–`#22`, [PR #57](https://github.com/sruj75/Intentive/pull/57), [PR #58](https://github.com/sruj75/Intentive/pull/58)), CP Identity + mobile launch hydration (`#23`, commit `8e65c71`), AR Runtime skeleton + WS gateway and CP Pre-Chat Gate (`#24`–`#26`, [PR #62](https://github.com/sruj75/Intentive/pull/62)), CP Device Registry + device-aware gates (`#27`, [PR #63](https://github.com/sruj75/Intentive/pull/63)), AR Sessions / Ordering / Event Ledger (`#28`, commit `ce43ad7`), AR Conversation History + reconnect snapshot (`#29`, [PR #65](https://github.com/sruj75/Intentive/pull/65)), CP Routing + Agent Instance + Session Start (`#30`, commit `a703b1e`), Desktop Routing + Protocol WS session (`#31`, [PR #71](https://github.com/sruj75/Intentive/pull/71)), Desktop Capture Permission Setup (`#32`, [PR #72](https://github.com/sruj75/Intentive/pull/72)), Mobile Protocol Runtime Adapter (`#33`, [PR #73](https://github.com/sruj75/Intentive/pull/73)), Desktop Snapshot emit over Protocol (`#34`, [PR #76](https://github.com/sruj75/Intentive/pull/76)), Desktop Signed-in Capture Session smoke (`#35`, branch `issue-35`), AR DeepAgents interactive turn (`#36`, [PR #79](https://github.com/sruj75/Intentive/pull/79))
- Open: `#37`–`#56`

## Executive Next Move

**Latest closure:** [#36 AR DeepAgents interactive turn](https://github.com/sruj75/Intentive/issues/36) ([PR #79](https://github.com/sruj75/Intentive/pull/79)) — Per-User Channel turn spine: DeepAgents adapter + Postgres checkpointing, companion persist via `conversation.append`, `runtime_turns` observability, and turn-failure containment without rejecting ingress ack (ADR-0020). Prior Desktop smoke closure ([#35](https://github.com/sruj75/Intentive/issues/35), branch `issue-35`) is recorded in Operating Frame and the Closed table.

**Now:** [#37 AR VFS / Bundles / Memory](https://github.com/sruj75/Intentive/issues/37) and [#41 AR Post-Message-Back + push handoff](https://github.com/sruj75/Intentive/issues/41) — parallel AR lanes after the interactive turn spine; client lanes [#43](https://github.com/sruj75/Intentive/issues/43) / [#44](https://github.com/sruj75/Intentive/issues/44) and shared [#51](https://github.com/sruj75/Intentive/issues/51)/[#52](https://github.com/sruj75/Intentive/issues/52) remain independently startable.

What it unlocks:

- `#31` + `#34` + `#35` (closed) → Desktop `#43` / `#55` — reliability harness and final packaged-app smoke.
- `#29` + `#30` + `#33` + `#36` (closed) → Mobile `#44` and AR `#37` / `#39` / `#41` — mobile reconnect and runtime VFS/live-delivery lanes.
...
| 29  | Agent Runtime | [Conversation History + Reconnect Snapshot](https://github.com/sruj75/Intentive/issues/29)                     | closed ([PR #65](https://github.com/sruj75/Intentive/pull/65)) — `conversation` domain, transcript, snapshot + backfill (ADR-0006/0008/0009); companion persist landed in #36; live delivery → #41                                                                      |
...
| --- | ------------------ | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 37  | Agent Runtime      | [VFS / Bundles / Memory](https://github.com/sruj75/Intentive/issues/37)                        | `#36` closed; gates #38 and #42                                                                                                                                                                        |
| 38  | Agent Runtime      | [Context Snapshots + Session End Markers](https://github.com/sruj75/Intentive/issues/38)       | Blocked by #37; required for #40                                                                                                                                                                       |
| 39  | Agent Runtime      | [Cron](https://github.com/sruj75/Intentive/issues/39)                                          | `#29` closed; parallel with #41                                                                                                                                                                        |
| 40  | Agent Runtime      | [Heartbeat](https://github.com/sruj75/Intentive/issues/40)                                     | Blocked by #38                                                                                                                                                                                         |
| 41  | Agent Runtime      | [Post-Message-Back + push handoff](https://github.com/sruj75/Intentive/issues/41)              | `#29` closed; owns live outbound delivery + per-user connected-client registry (deferred from #29) — [scope-down](https://github.com/sruj75/Intentive/issues/41#issuecomment-4666591065); unblocks #49 |
| 42  | Agent Runtime      | [Observability / safety / prod readiness](https://github.com/sruj75/Intentive/issues/42)       | Blocked by #37/#39/#40/#41                                                                                                                                                                             |
| 43  | Desktop            | [Reliability + privacy verification harness](https://github.com/sruj75/Intentive/issues/43)    | `#35` closed on branch `issue-35`; privacy/reliability verification gate; unblocks #55                                                                                                                 |
...
| 49  | Control Plane      | [Push notification fan-out](https://github.com/sruj75/Intentive/issues/49)                     | Blocked by #41 (device registry landed in #27); completes Post-Message-Back → APNs path                                                                                                                |
...
| 51  | Shared             | [Providers telemetry + feature flags](https://github.com/sruj75/Intentive/issues/51)           | `#14` closed; observability for #50 and #42                                                                                                                                                            |
...
| 55  | Desktop            | [Final packaged-app release smoke](https://github.com/sruj75/Intentive/issues/55)              | Blocked by #43/#53/#54; release bar                                                                                                                                                                    |
...
### Desktop Client (issues #7–#13, #31–#35 closed; #43, #53–#56 open)
...
- **Next:** Reliability/privacy harness (`#43`).
...
### Agent Runtime (issues #16, #24, #25, #28–#29, #36 closed; #37–#42 open)
...
- **Next:** `#37` (VFS / Bundles / Memory) and `#41` (Post-Message-Back) on the closed turn spine; `#39` (Cron) can run in parallel with `#41`.
