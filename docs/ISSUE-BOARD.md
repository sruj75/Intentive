...
- Closed: `#7`–`#34` — Desktop v1 foundation (`#7`–`#13`), shared protocol/api-contract + Providers auth (`#14`–`#15`), AR/CP contract roots (`#16`–`#17`, [PR #57](https://github.com/sruj75/Intentive/pull/57)), Mobile foundation lane (`#18`–`#22`, [PR #57](https://github.com/sruj75/Intentive/pull/57), [PR #58](https://github.com/sruj75/Intentive/pull/58)), CP Identity + mobile launch hydration (`#23`, commit `8e65c71`), AR Runtime skeleton + WS gateway and CP Pre-Chat Gate (`#24`–`#26`, [PR #62](https://github.com/sruj75/Intentive/pull/62)), CP Device Registry + device-aware gates (`#27`, [PR #63](https://github.com/sruj75/Intentive/pull/63)), AR Sessions / Ordering / Event Ledger (`#28`, commit `ce43ad7`), AR Conversation History + reconnect snapshot (`#29`, [PR #65](https://github.com/sruj75/Intentive/pull/65)), CP Routing + Agent Instance + Session Start (`#30`, commit `a703b1e`), Desktop Routing + Protocol WS session (`#31`, [PR #71](https://github.com/sruj75/Intentive/pull/71)), Desktop Capture Permission Setup (`#32`, [PR #72](https://github.com/sruj75/Intentive/pull/72)), Mobile Protocol Runtime Adapter (`#33`, [PR #73](https://github.com/sruj75/Intentive/pull/73)), Desktop Snapshot emit over Protocol (`#34`, [PR #76](https://github.com/sruj75/Intentive/pull/76))
- Open: `#35`–`#56`

## Executive Next Move

**Latest closure:** [#34 Desktop Snapshot emit](https://github.com/sruj75/Intentive/issues/34) ([PR #76](https://github.com/sruj75/Intentive/pull/76)) — `WsSessionAgentSink` bridge emits `context_snapshot` and `session_end_marker` through the live Routing `WsSession`, stamps `pushed_at` on socket-write acceptance (ADR-0005 at-most-once, no Runtime→Client ack), golden fixtures + Rust/Vitest contract tests lock the serializer to `@intentive/protocol`. Prior mobile Protocol closure ([#33](https://github.com/sruj75/Intentive/issues/33), [PR #73](https://github.com/sruj75/Intentive/pull/73)) is recorded in Operating Frame and the Closed table.

**Now:** [#35 Desktop Signed-in smoke](https://github.com/sruj75/Intentive/issues/35) and [#44 Mobile Reconnect hydration](https://github.com/sruj75/Intentive/issues/44) — parallel client lanes after Protocol wiring. Shared [#51](https://github.com/sruj75/Intentive/issues/51)/[#52](https://github.com/sruj75/Intentive/issues/52) are independently startable.

What it unlocks:

- `#31` + `#34` (closed) → Desktop `#35` / `#43` — signed-in smoke and reliability harness.
...
| 34  | Desktop       | [Emit Context Snapshots over Protocol](https://github.com/sruj75/Intentive/issues/34)                          | closed ([PR #76](https://github.com/sruj75/Intentive/pull/76)) — `WsSessionAgentSink` bridge, `context_snapshot` + `session_end_marker` over live `WsSession`, `pushed_at` on socket-write acceptance, golden contract tests, ADR-0005 at-most-once; signed-in smoke deferred to #35 |

### Open

| #   | Deployable         | Issue                                                                                          | Notes                                                                                                                                                                                                  |
| --- | ------------------ | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 35  | Desktop            | [Signed-in happy-path smoke](https://github.com/sruj75/Intentive/issues/35)                    | `#34` + `#32` closed; unblocks #43/#55                                                                                                                                                                 |
| 36  | Agent Runtime      | [DeepAgents integration](https://github.com/sruj75/Intentive/issues/36)                        | `#29` closed; owns companion-message persistence via `conversation.append` (one call, verify by reconnect) — [scope-down](https://github.com/sruj75/Intentive/issues/36#issuecomment-4666590934)       |
| 37  | Agent Runtime      | [VFS / Bundles / Memory](https://github.com/sruj75/Intentive/issues/37)                        | Blocked by #36; gates #38 and #42                                                                                                                                                                      |
...
| 43  | Desktop            | [Reliability + privacy verification harness](https://github.com/sruj75/Intentive/issues/43)    | Blocked by #35; privacy/reliability verification gate; unblocks #55                                                                                                                                    |
...
### Desktop Client (issues #7–#13, #31–#34 closed; #35, #43, #53–#56 open)
