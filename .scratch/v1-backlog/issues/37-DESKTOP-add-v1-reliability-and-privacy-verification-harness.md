...
Keep #37 focused on reliability/privacy verification, but include the new launch-gating assertions in the harness or documented smoke matrix where they touch privacy:
...
The signed/notarized DMG mechanics live in #47; #37 should reference that issue rather than taking on release engineering itself.

### 02 @sruj75 — 2026-05-21T12:34:54Z

Follow-up links from the packaging issue pass:

- Signed/notarized release packaging: #47
- Product-owned macOS Privacy Settings identity: #48
- Capture Permission Setup and hard permission gates: #26
- Final packaged-app release smoke: #49

#37 should verify privacy/reliability behavior and reference these issues for the launch packaging and permission-identity release gates.
