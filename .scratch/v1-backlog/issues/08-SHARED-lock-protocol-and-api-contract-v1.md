...
- [ ] Handshake behavior for this policy is specified: how `min_protocol`/`max_protocol` map to `negotiated_protocol`, and what a client sees when no compatible version exists.
