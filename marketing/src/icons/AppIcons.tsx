...
export const SlackIcon: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 128 128">
    ...
    <path
      d="M33.6 80.4a13.4 13.4 0 0 1 26.8 0v33.5a13.4 13.4 0 1 1-26.8 0V80.4z"
      fill="#E01E5A"
    />
    <path d="M47 26.9a13.4 13.4 0 1 1 13.4-13.4v13.4H47z" fill="#36C5F0" />
    <path
      d="M47 33.6a13.4 13.4 0 0 1 0 26.8H13.4a13.4 13.4 0 0 1 0-26.8H47z"
      fill="#36C5F0"
    />
    <path d="M100.6 47a13.4 13.4 0 1 1 13.4 13.4h-13.4V47z" fill="#2EB67D" />
    <path
      d="M93.9 47a13.4 13.4 0 0 1-26.8 0V13.4a13.4 13.4 0 0 1 26.8 0V47z"
      fill="#2EB67D"
    />
    <path
      d="M80.5 100.6a13.4 13.4 0 1 1-13.4 13.4v-13.4h13.4z"
      fill="#ECB22E"
    />
    <path
      d="M80.5 93.9a13.4 13.4 0 0 1 0-26.8h33.5a13.4 13.4 0 0 1 0 26.8H80.5z"
      fill="#ECB22E"
    />
  </svg>
);
...
export const VSCodeIcon: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100">
    ...
    <path
      d="M71.6 99.1l24.7-12.3a5.4 5.4 0 0 0 3-4.9V18.1a5.4 5.4 0 0 0-3-4.9L71.5.9a5.4 5.4 0 0 0-6.2 1.1L27.7 37.6 11.5 25.1a3.6 3.6 0 0 0-4.6.3L1.2 31a3.6 3.6 0 0 0 0 5.3L15.5 50 1.2 63.7a3.6 3.6 0 0 0 0 5.3l5.7 5.6a3.6 3.6 0 0 0 4.6.3L27.7 62.4l37.6 35.6a5.4 5.4 0 0 0 6.3 1.1zM71.6 27L42 50l29.6 23V27z"
      fill="#007ACC"
    />
  </svg>
);
...
export const CalendarIcon: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48">
    <path
      d="M36 6h-2V2h-4v4H18V2h-4v4h-2C9.8 6 8 7.8 8 10v28c0 2.2 1.8 4 4 4h24c2.2 0 4-1.8 4-4V10c0-2.2-1.8-4-4-4zm0 32H12V16h24v22z"
      fill="#4285F4"
    />
...
export const ZoomIcon: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48">
    ...
    <path
      d="M11 17a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v14a3 3 0 0 1-3 3H14a3 3 0 0 1-3-3V17z"
      fill="white"
    />
...
export const LinearIcon: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100">
    ...
    <path
      d="M19.2 68.8a40 40 0 0 0 12 12l36.4-36.4a3 3 0 0 0 0-4.2 3 3 0 0 0-4.2 0L19.2 68.8zm-3.3 3.3c-.4.4-.4 1 0 1.4a40 40 0 0 0 10.5 10.5c.4.4 1 .4 1.4 0L67.6 44.2a3 3 0 0 0 0-4.2 3 3 0 0 0-4.2 0L15.9 72.1z"
      fill="white"
      fillOpacity="0.9"
    />
    <circle
...
export const GmailIcon: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48">
    <path
      d="M6 12l18 12 18-12v24a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V12z"
      fill="#EA4335"
    />
    <path
      d="M42 12L24 24 6 12V8a2 2 0 0 1 2-2h32a2 2 0 0 1 2 2v4z"
      fill="#FBBC04"
    />
...
export const GoogleDocsIcon: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48">
    <path
      d="M29 4H14a4 4 0 0 0-4 4v32a4 4 0 0 0 4 4h20a4 4 0 0 0 4-4V13L29 4z"
      fill="#4285F4"
    />
...
export const IntentiveIcon: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 64 64"
    role="img"
    aria-label="Intentive"
  >
    <defs>
      <linearGradient
        id="intentive-mark"
    ...
    <path
      d="M18 20c0-2.2 1.8-4 4-4h20c2.2 0 4 1.8 4 4v24c0 2.2-1.8 4-4 4H22c-2.2 0-4-1.8-4-4V20Z"
      fill="url(#intentive-mark)"
    />
    <path d="M28 24h8v16h-8z" fill="white" opacity="0.95" />
    <path d="M24 20h16v6H24zM24 38h16v6H24z" fill="white" opacity="0.78" />
  </svg>
);
