...
const FakeSearchBar: React.FC<{ query: string; charCount: number }> = ({
  query,
  charCount,
}) => {
...
export const SearchLostCopyScene: React.FC = () => {
  ...
  const results = [
    {
      icon: "🌐",
      title: "Chrome — Spring Campaign Draft",
      context: '"Free shipping on all orders over $50 — limited time only"',
      time: "3:12 PM",
      highlight: true,
    },
    {
      icon: "📄",
      title: "Google Docs — Ad Copy v3",
      context: "Headline B: Free shipping + 20% off spring collection",
      time: "1:45 PM",
      highlight: false,
    },
    {
      ...
      context: '"Can we add free shipping to the banner copy?"',
      time: "11:30 AM",
      highlight: false,
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2
            style={{ color: "white", fontSize: 20, fontWeight: 700, margin: 0 }}
          >
          ...
          >
            You were editing ad copy in the browser and accidentally closed the
            tab. Instead of rewriting from scratch, search for any phrase you
            remember — Screen Memory finds the exact screen where you had it
            open.
          </p>
