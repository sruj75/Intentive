  ...
  const items = [
    {
      ...
      description:
        "All screenshots are stored on your Mac. Nothing leaves your device.",
    },
    {
      icon: "🔒",
      title: "Password apps excluded",
      description:
        "1Password, Keychain, and other sensitive apps are automatically skipped.",
    },
    {
      icon: "🗑️",
      title: "Auto-cleanup",
      description:
        "Old data is automatically deleted based on your retention settings.",
    },
    {
      icon: "⏸️",
      title: "Pause anytime",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Screen Memory is built with privacy at its core. Everything stays
              on your machine.
            </p>
          </div>
        </div>
        ...
        >
          {items.map((item, i) => {
            ...
            return (
              <PrivacyItem key={i} {...item} opacity={itemOpacity} y={itemY} />
            );
          })}
        </div>
      </div>
