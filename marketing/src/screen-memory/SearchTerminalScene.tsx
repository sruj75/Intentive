...
export const SearchTerminalScene: React.FC = () => {
  ...
  const results = [
    {
      icon: "⬛",
      title: "Terminal — ssh session",
      context: "ssh deploy@staging.acme.io -i ~/.ssh/deploy_key",
      time: "Yesterday",
      highlight: true,
    },
    {
      icon: "⬛",
      title: "Terminal — docker deploy",
      context: "docker compose -f staging.yml up -d --build",
      time: "Yesterday",
      highlight: false,
    },
    {
      icon: "📄",
      title: "Notion — Deployment Runbook",
      context: "Step 3: SSH into staging and run deploy script",
      time: "Last week",
      highlight: false,
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            You ran a deploy command in an SSH session last week but the
            terminal history is long gone. Just search for what you remember —
            Screen Memory finds the full command from your screen.
          </p>
