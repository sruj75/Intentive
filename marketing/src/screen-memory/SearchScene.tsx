...
export const SearchScene: React.FC = () => {
  ...
  const results = [
    {
      icon: "📄",
      title: "Q1 Product Launch Plan — Google Docs",
      context: "Launch day — Mar 15 🚀",
      time: "2:34 PM",
    },
    {
      icon: "💬",
      title: "Slack — #product-team",
      context: '"Let\'s finalize the launch date this week"',
      time: "11:20 AM",
    },
    {
      icon: "📧",
      title: "Gmail — Launch timeline update",
      context: "Confirmed: March 15 go-live",
      time: "Yesterday",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Type what you remember — a word, a name, a topic. Screen Memory
            searches through every screen you've seen and finds exactly where it
            appeared.
          </p>
