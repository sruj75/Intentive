...
const FakeScreenshot: React.FC<{
  ...
  >
    ...
    >
      <div style={{ color: "#e5e5e5", fontSize: 9, fontWeight: 600 }}>
        {title}
      </div>
      <div
        style={{
    ...
    >
      ...
      >
          ...
          <div style={{ display: "flex", gap: 6, position: "relative" }}>
            {screenshots.map((s, i) => (
              ...
              >
                ...
                <span
                  style={{
                    color: i === activeIndex ? "#8b5cf6" : "#6b7280",
                    fontSize: 7,
        ...
        >
          ...
          >
            Browse your screen timeline like a visual history. Scrub backward to
            revisit anything you were working on — every app, every tab, every
            moment.
          </p>
