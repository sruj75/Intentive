...
const UseCaseCard: React.FC<{
  ...
  >
    ...
    <div style={{ color: "#a1a1aa", fontSize: 9, lineHeight: 1.4 }}>
      {description}
    </div>
    <div
      style={{
  ...
  const useCases = [
    {
      ...
      title: "Code & terminal",
      description:
        "Find that snippet, function, or terminal command from earlier.",
    ...
    },
    {
      ...
      title: "Chat & messages",
      description:
        "Find that Slack message, email, or conversation you saw fly by.",
    ...
    },
    {
      ...
      description:
        "Search through lectures, tutorials, or YouTube videos you watched.",
    ...
    },
    {
      ...
      description:
        "Browser crashed? Forgot to save? Scroll back and recover your data.",
