...
const AudioWaveform: React.FC = () => {
  ...
  return (
    <div
      style={{ display: "flex", alignItems: "center", gap: 1.5, height: 40 }}
    >
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Real-time transcription of meetings, calls, and conversations with
            speaker detection.
          </p>
        </div>
