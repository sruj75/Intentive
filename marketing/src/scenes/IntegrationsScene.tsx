...
const AppIcon: React.FC<{
  ...
  return (
    ...
    >
      ...
      <span style={{ color: "#9ca3af", fontSize: 8, fontWeight: 500 }}>
        {name}
      </span>
    </div>
  );
    ...
    >
      ...
      >
        <p style={{ color: "#a1a1aa", fontSize: 11, margin: 0 }}>
          Connects to your entire workflow — passing context seamlessly between
          apps
        </p>
      </div>
    </AbsoluteFill>
