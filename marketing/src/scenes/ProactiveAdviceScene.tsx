  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ color: "#9ca3af", fontSize: 9, lineHeight: 1.4 }}>
          {body}
        </div>
      </div>
    </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Based on your screen and conversations, Intentive proactively
            surfaces tips, reminders, and insights — right when you need them.
          </p>
        </div>
