    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ color: "#333", fontSize: 10, fontWeight: 500 }}>
            Q1 Product Launch Plan — Google Docs
          </span>
        </div>
      </div>
      ...
      >
        {["File", "Edit", "View", "Insert", "Format"].map((item) => (
          <span key={item} style={{ color: "#5f6368", fontSize: 9 }}>
            {item}
          </span>
        ))}
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <span style={{ color: "white", fontSize: 8, fontWeight: 600 }}>
              Intentive is watching
            </span>
          </div>
        </div>
        ...
        >
          ...
          >
            Intentive monitors your screen to understand what you're working on
            — docs, code, emails, meetings.
          </p>
